  ...
  return (
    <>
      ...
      <div className=" md:my-24 md:mx-24  grid gap-12 lg:grid-cols-4 md:grid-cols-1 grid-cols-1">
        <div className="min-h-[60vh] w-full max-w-[88vw] lg:max-w-[16vw] md:max-w-[50vw] rounded-md flex flex-col justify-between bg-gradient-to-tl from-[#000000] to-[#002774] mx-auto overflow-hidden border-[#575757] border">
          {/* Top Section */}
          <div className="max-h-[40vh] flex flex-col px-4 rounded-tr-md rounded-tl-md bg-[#f1f1f1] relative overflow-hidden">
            {/* Social icons */}
        ...
        <div className="min-h-[60vh] w-full max-w-[88vw] lg:max-w-[16vw] md:max-w-[50vw] rounded-md flex flex-col justify-between bg-gradient-to-tl from-[#000000] to-[#002774] mx-auto overflow-hidden border-[#575757] border">
          ...
          <div className="max-h-[40vh] flex flex-col px-4 rounded-tr-md rounded-tl-md bg-[#f1f1f1] relative overflow-hidden">
            ...
            <div className="flex-1 flex items-end justify-center pt-2 md:pb-4 relative">
              ...
              <img
                src={kamal}
                alt="Sarthak"
                className="min-h-[15vh] md:min-h-[25vh] w-auto object-contain relative md:mt-8 lg:mt-0 "
              />
            </div>
          </div>
          ...
          {/* Bottom Section */}
          <div className="px-4 py-8 flex flex-col gap-2">
            <h1 className="font-bold text-xl text-white">Kamal</h1>
          ...
          <div className="max-h-[40vh] flex flex-col px-4 rounded-tr-md rounded-tl-md bg-[#f1f1f1] relative overflow-hidden">
            ...
            <div className="flex-1 flex items-end justify-center pt-2 md:pb-4 relative">
              ...
              <img
                src={anurag}
                alt="Sarthak"
                className="min-h-[15vh] md:min-h-[25vh] w-auto object-contain relative mt-4 md:mt-8 lg:mt-4"
              />
            </div>
          </div>
          ...
          <div className="max-h-[40vh] flex flex-col px-4 rounded-tr-md rounded-tl-md bg-[#f1f1f1] relative overflow-hidden">
            ...
            <div className="flex-1 flex items-end justify-center pt-2 md:pb-4 relative">
              ...
              <img
                src={sarthak}
                alt="Sarthak"
                className="min-h-[15vh] md:min-h-[25vh] w-auto object-fill relative md:mt-8 lg:mt-0"
              />
            </div>
          </div>
