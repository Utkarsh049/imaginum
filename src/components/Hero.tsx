  ...
  return (
    <>
      <div className="flex justify-center mt-[6rem] flex-col items-center gap-6">
        <div className="px-4 py-1 text-[#D4FA00] border border-[#D4FA00] rounded-full text-[0.75rem] bg-gradient-to-r from-[#006FFF] via-transparent to-transparent  text-center font-lexend font-light">
